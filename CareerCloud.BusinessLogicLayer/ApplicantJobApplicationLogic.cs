...
namespace CareerCloud.BusinessLogicLayer
{
    ...
    {
        public ApplicantJobApplicationLogic(
            IDataRepository<ApplicantJobApplicationPoco> repo): base(repo)
        {}
        ...
        protected override void Verify(ApplicantJobApplicationPoco[] pocos)
        {
            ...
            foreach (var item in pocos)
            {
                ...
                {
                    exceptions.Add(new ValidationException(110, $"Cannot be greater than today"));
                }
            }
